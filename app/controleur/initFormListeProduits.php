...
for ($i = 0; $i < count($produits); $i++) {
    ...
    $produit .= "<li class='sub-item'><img class='image' alt=" . htmlspecialchars($produits[$i]->getTitre(), ENT_QUOTES, 'UTF-8') . " src='/images/" . htmlspecialchars($produits[$i]->getImg(), ENT_QUOTES, 'UTF-8') . "'></li>";        
